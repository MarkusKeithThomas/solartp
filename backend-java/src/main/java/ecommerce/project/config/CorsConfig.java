...
public class CorsConfig {
    ...
    public CorsConfigurationSource corsConfigurer() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173","https://solartp.com.vn","http://127.0.0.1:5500","http://127.0.0.1:5501")); // ✅ Cho phép frontend truy cập
